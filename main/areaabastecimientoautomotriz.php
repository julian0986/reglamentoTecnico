...
<head>
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="d-grid gap-2">
        <button class="btn btn-danger btn-lg" type="button" data-bs-toggle="collapse"
          data-bs-target="#multiCollapseExample1" aria-expanded="false" aria-controls="multiCollapseExample1">6.2.a Ingreso y salida de <br> vehículos</button>
            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img
                    src="./src/img/imgAutomotriz/Area abastecimiento/g.2a.png"
    ...
    <div class="col-md-3">
      <div class="d-grid gap-2">
        <button class="btn btn-danger btn-lg" type="button" data-bs-toggle="collapse"
          data-bs-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">6.2.b distancia entre los carriles de abastecimiento</button>
          ...
          <div class="card">
            ...
            <div id="carouselExampleControls1" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img
                    src="./src/img/imgAutomotriz/Area abastecimiento/6.2b.png"
                    class="d-block w-100" alt="...">
                </div>
              </div>
            </div>
    ...
    <div class="col-md-3">
      <div class="d-grid gap-2">
        <button class="btn btn-danger btn-lg" type="button" data-bs-toggle="collapse"
          data-bs-target="#multiCollapseExample3" aria-expanded="false" aria-controls="multiCollapseExample3">6.2.c Distancia minima entre equipos de medición</button>
    ...
    <div class="col-md-3">
      <div class="d-grid gap-2">
        <button class="btn btn-warning btn-lg" type="button" data-bs-toggle="collapse"
          data-bs-target="#multiCollapseExample4" aria-expanded="false" aria-controls="multiCollapseExample4">6.1.d Distancia de los equipos de medición</button>
          ...
          <div class="card">
            ...
            <div id="carouselExampleControls3" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img
                    src="./src/img/imgAutomotriz/Area abastecimiento/6.2.d.png"
                    class="d-block w-100" alt="...">
                </div>
              </div>
  ...
  <div class="row mt-2">
    <div class="col-md-3">
      <div class="d-grid gap-2">
        <button class="btn btn-default btn-lg border border-danger" type="button" data-bs-toggle="collapse"
          data-bs-target="#multiCollapseExample5" aria-expanded="false" aria-controls="multiCollapseExample5">6.1.e Demarcado de los carriles de Abastecimiento</button>
          ...
          <div class="card">
            ...
            <div id="carouselExampleControls4" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img
                    src="./src/img/imgAutomotriz/Area abastecimiento/6.2.e.PNG"
                    class="d-block w-100" alt="...">
                </div>
              </div>
            </div>
    ...
    <div class="col-md-3">
      <div class="d-grid gap-2">
        <button class="btn btn-danger btn-lg" type="button" data-bs-toggle="collapse"
          ...
          aria-controls="multiCollapseExample6">6.1.f Largo máximo de la manguera de distribución</button>
    ...
    <div class="col-md-3">
      <div class="d-grid gap-2">
        <button class="btn btn-danger btn-lg" type="button" data-bs-toggle="collapse"
          data-bs-target="#multiCollapseExample8" aria-expanded="false" aria-controls="multiCollapseExample8">6.1.fI Reglamento para pistolas con mangueras de 6m o mas</button>
    ...
    <div class="col-md-3">
      <div class="d-grid gap-2">
        <button class="btn btn-danger btn-lg" type="button" data-bs-toggle="collapse"
          data-bs-target="#multiCollapseExample7" aria-expanded="false" aria-controls="multiCollapseExample7">6.1.g Ubicación del equipo de medición dentro de la EDS</button>
          ...
          <div class="card">
            ...
            <div id="carouselExampleControls6" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img
                    src="./src/img/imgAutomotriz/Area abastecimiento/6.2g.png"
                    class="d-block w-100" alt="...">
                </div>
              </div>
            </div>
